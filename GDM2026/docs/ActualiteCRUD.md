...
si elle est fournie, la valeur doit cibler une ressource de la catégorie `image` avec un `Content-Type` de la forme `image/...`.
Exemple minimal avec des clés génériques :
