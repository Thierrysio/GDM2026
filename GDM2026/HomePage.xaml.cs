...
namespace GDM2026
{
    public partial class HomePage : ContentPage
    {
        ...
        {
            if (sender is not BindableObject bindable || bindable.BindingContext is not OrderStatus status)
            {
                return;
            }
            ...
            await Shell.Current.GoToAsync(nameof(OrderStatusPage), new Dictionary<string, object>
            {
